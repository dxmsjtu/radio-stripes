...
%This function computes achievable SE of a radio stripes network with centralized LMMSE (Level - 4) receiver
...
%Generates SE data (K x 1) vector where SE(k) is achievable SE of UE k with centralized LMMSE prcoessing (L4 processing)
