...
%This function computes achievable SE of a radio stripes network with sequential MR receiver
...
%
%Generates SE data (K x 1) vector where SE(k) is achievable SE of UE k with centralized SMR (Sequential MR) prcoessing
