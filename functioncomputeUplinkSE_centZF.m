...
%This function computes achievable SE of a radio stripes network with centralized ZF receiver
...
%use this code for research that results in publications, please cite our paper as described above.
%INPUT:
...
%
%Generates SE data (K x 1) vector where SE(k) is achievable SE of UE k with centralized ZF prcoessing
...
% This reshape to 3rd dimension is done because: R_tilde's variable 3rd dimension is UEs and SE expression requires weighted sum of
% error covariance matrices over all UEs where weights are power coefficients. Hence, it would be easy to obtain the summation as below:
